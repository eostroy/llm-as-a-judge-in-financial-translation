# LLM-as-a-Judge Translation Benchmark: Claude-Version

This version contains the overseas-model candidate generation condition.
It mirrors `kimi-version/`, so the same relative paths can be compared across
